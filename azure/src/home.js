 ...
 console.log("sorted")
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <Nav>
      ...
      <FormControl type="text" placeholder="Search Blogs by title " onChange={(e)=>setSearch(e.target.value)} className="mr-sm-2" className="searchbar"/>
...
{data.sort((a,b)=>{
 ...
 .
filter((s)=>{
  if(s.Title.toLowerCase().includes(search) || s.Author.toLowerCase().includes(search) || s.content.toLowerCase().includes(search)){
    return s
  }
})
